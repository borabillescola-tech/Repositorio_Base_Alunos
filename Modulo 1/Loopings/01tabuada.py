# Solicite ao usuário um número inteiro de 1 a 10 e construa a tabuada deste número.

num = int(input("Digite um número inteiro de 1 a 10: ")) # solicitamos o número ao usuário
